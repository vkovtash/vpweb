function AddBookmark(href, title)
{
    ...
    //var p='u=' + encodeURIComponent(href) + '&t=' + encodeURIComponent(title);
        
    //alert("p:"+p);
    title=title.substring(12);
    
    i=document.createElement('iframe');
    i.setAttribute('name', 'vipaperbk');
    i.setAttribute('id', 'vipaperbk');
    ...
    i.onload = function(){ setTimeout(CloseFrame, 350); }
 
    window['vipaperbk'].document.write(
        ...
        '<div style="text-align: center; width: 80%; padding-bottom: 1px; margin: 0 auto 15px auto; font-size: 13px; border-bottom: 1px solid #ccc; color: #333;">ViPaper</div>' +
        'Saving...' +
        '<form action="' + document.location.protocol + '//localhost:8086/addbookmark" method="post" id="f" accept-charset="utf-8">' +
...
function CloseFrame() 
{ 
    var f = document.getElementById('vipaperbk');
    f.style.display = 'none'; 
    f.parentNode.removeChild(f);
    document.title=document.title.substring(12);
}
